...
// Documentation-only stories that showcase the design tokens.
// NOTE: values are iso-charter with Meridian for now (see tokens.css).
const meta: Meta = {
  title: 'Foundations/Charte',
  parameters: {
    layout: 'fullscreen',
    a11y: { disable: true },
  },
...
const COLORS = [
  { name: 'navy',         token: '--wp-color-navy',         note: 'Primaire — navbar, titres, boutons primary' },
  { name: 'sky',          token: '--wp-color-sky',          note: 'Accent énergie — liens, états actifs' },
  { name: 'gold',         token: '--wp-color-gold',         note: 'CTA — conversion, invitation à agir' },
  { name: 'orange',       token: '--wp-color-orange',       note: 'Actions critiques — destructif, danger' },
  { name: 'silver',       token: '--wp-color-silver',       note: 'Secondaire — textes, bordures' },
  { name: 'dark-bg',      token: '--wp-color-dark-bg',      note: 'Fond dark mode (portail communauté)' },
  { name: 'bg',           token: '--wp-color-bg',           note: 'Fond page light mode' },
  { name: 'border',       token: '--wp-color-border',       note: 'Bordures standard' },
  { name: 'muted',        token: '--wp-color-muted',        note: 'Méta-texte (sur fond sombre)' },
  { name: 'success',      token: '--wp-color-success',      note: 'Statut — succès' },
  { name: 'warning',      token: '--wp-color-warning',      note: 'Statut — avertissement' },
  { name: 'error',        token: '--wp-color-error',        note: 'Statut — erreur' },
]
