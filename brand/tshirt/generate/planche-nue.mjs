...
import { TEE, HEM, img, poser } from './silhouette.mjs'
...
const panel = (tx, content) => `<g transform="translate(${tx},${TY})">
...
${panel(TX1, img(dos,   100 - dW / 2, dTop, dW, dH))}
${panel(TX2, img(coeur, cCx - cW / 2, cTop, cW, cH))}
</svg>`
