import{d as F,e as a,t as S,i as c,g as t,F as W,m as R,p as C,n as T,h as o,o as n}from"./iframe-BEQMzRqY.js";import{_ as V}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./preload-helper-PPVm8Dsz.js";const q=["aria-label"],E={key:0},M={class:"wp-patch__art"},Z=["d"],_={key:0,class:"wp-patch__pleat",cx:"50",cy:"50",r:"44"},B=["d"],N=["transform"],O={key:1,points:"-13,1 -4,11 14,-12",fill:"none","stroke-width":"5","stroke-linecap":"round","stroke-linejoin":"round"},I={key:2,fill:"none","stroke-width":"2.2"},D={key:3,d:"M0,-16 L4.7,-4.9 16.5,-4.9 7,2.5 10.6,13.9 0,7 -10.6,13.9 -7,2.5 -16.5,-4.9 -4.7,-4.9 Z"},G={key:4,d:"M0,13 C-13,3 -16,-6 -8.5,-12 C-3.5,-15.5 0,-10.5 0,-7.5 C0,-10.5 3.5,-15.5 8.5,-12 C16,-6 13,3 0,13 Z"},$={key:5},H={key:3,class:"wp-patch__banner"},j={x:"50",y:"69","text-anchor":"middle","dominant-baseline":"central"},Q={key:4,class:"wp-patch__pastille"},U={x:"74",y:"22","text-anchor":"middle","dominant-baseline":"central"},Y=["aria-label"],y=F({__name:"WpPatch",props:{shape:{default:"circle"},tier:{default:"none"},accent:{},icon:{},flag:{},bannerText:{},count:{},locked:{type:Boolean,default:!1},size:{default:96},name:{},description:{}},setup(e){const s=e,P=o(()=>{switch(s.shape){case"shield":return"M50 5 L91 17 V49 C91 73 73 89 50 95 C27 89 9 73 9 49 V17 Z";case"hexagon":return"M50 4 L90 27 V73 L50 96 L10 73 V27 Z";case"rocker":return"M8 24 Q50 12 92 24 L92 56 Q50 88 8 56 Z";default:return"M4 50 A46 46 0 1 1 96 50 A46 46 0 1 1 4 50 Z"}}),w=o(()=>{switch(s.shape){case"shield":return"M50 13 L84 23 V49 C84 68 70 81 50 87 C30 81 16 68 16 49 V23 Z";case"hexagon":return"M50 13 L82 31 V69 L50 87 L18 69 V31 Z";case"rocker":return"";default:return"M11 50 A39 39 0 1 1 89 50 A39 39 0 1 1 11 50 Z"}}),z=o(()=>s.name??s.bannerText??"Achievement patch"),A=o(()=>s.bannerText?36:50),L=o(()=>{const v={width:`${s.size}px`,height:`${s.size}px`};return s.accent&&(v["--patch-ring"]=s.accent),v});return(v,r)=>(n(),a("span",{class:T(["wp-patch",`wp-patch--${e.tier}`,{"wp-patch--locked":e.locked}]),style:C(L.value)},[(n(),a("svg",{class:"wp-patch__svg",viewBox:"0 0 100 100",role:"img","aria-label":z.value},[e.description||e.name?(n(),a("title",E,S(e.description??e.name),1)):c("",!0),t("g",M,[t("path",{class:"wp-patch__shape",d:P.value},null,8,Z),e.shape==="rosette"?(n(),a("circle",_)):c("",!0),w.value?(n(),a("path",{key:1,class:"wp-patch__inner",d:w.value},null,8,B)):c("",!0),e.icon&&!e.flag?(n(),a("g",{key:2,class:"wp-patch__emblem",transform:`translate(50 ${A.value}) scale(1.3)`},[e.icon==="propeller"?(n(),a(W,{key:0},[r[0]||(r[0]=t("ellipse",{cx:"0",cy:"0",rx:"5.5",ry:"17"},null,-1)),r[1]||(r[1]=t("ellipse",{cx:"0",cy:"0",rx:"17",ry:"5.5"},null,-1)),r[2]||(r[2]=t("circle",{cx:"0",cy:"0",r:"6",class:"wp-patch__emblem-hub"},null,-1))],64)):e.icon==="check"?(n(),a("polyline",O)):e.icon==="globe"?(n(),a("g",I,[...r[3]||(r[3]=[R('<circle cx="0" cy="0" r="15" data-v-cb04a2d3></circle><ellipse cx="0" cy="0" rx="6.5" ry="15" data-v-cb04a2d3></ellipse><line x1="-15" y1="0" x2="15" y2="0" data-v-cb04a2d3></line><line x1="-13" y1="-7.5" x2="13" y2="-7.5" data-v-cb04a2d3></line><line x1="-13" y1="7.5" x2="13" y2="7.5" data-v-cb04a2d3></line>',5)])])):e.icon==="star"?(n(),a("path",D)):e.icon==="heart"?(n(),a("path",G)):e.icon==="flag"?(n(),a("g",$,[...r[4]||(r[4]=[t("rect",{x:"-12",y:"-15",width:"3",height:"30",rx:"1"},null,-1),t("path",{d:"M-9,-14 L13,-9 L-9,-1 Z"},null,-1)])])):c("",!0)],8,N)):c("",!0),e.bannerText?(n(),a("g",H,[r[5]||(r[5]=t("rect",{x:"14",y:"60",width:"72",height:"17",rx:"3"},null,-1)),t("text",j,S(e.bannerText),1)])):c("",!0),e.count!=null?(n(),a("g",Q,[r[6]||(r[6]=t("circle",{cx:"74",cy:"22",r:"11"},null,-1)),t("text",U,S(e.count),1)])):c("",!0)])],8,q)),e.flag?(n(),a("span",{key:0,class:T(["wp-patch__flag fi fis",`fi-${e.flag}`]),style:C({top:e.bannerText?"36%":"50%"}),role:"img","aria-label":e.name??e.flag},null,14,Y)):c("",!0)],6))}}),k=V(y,[["__scopeId","data-v-cb04a2d3"]]);y.__docgenInfo=Object.assign({displayName:y.name??y.__name},{exportName:"default",displayName:"WpPatch",description:"",tags:{},props:[{name:"shape",description:"Category silhouette",required:!1,type:{name:"WpPatchShape"},defaultValue:{func:!1,value:"'circle'"}},{name:"tier",description:"Threshold metal — drives the ring/accent color",required:!1,type:{name:"WpPatchTier"},defaultValue:{func:!1,value:"'none'"}},{name:"accent",description:"CSS color overriding the ring/banner/pastille color (e.g. a category accent)",required:!1,type:{name:"string"}},{name:"icon",description:"Central emblem from the starter icon registry (ignored when `flag` is set)",required:!1,type:{name:"WpPatchIcon"}},{name:"flag",description:"ISO 3166-1 alpha-2 country code (lowercase) — renders a flag medallion as the emblem",required:!1,type:{name:"string"}},{name:"bannerText",description:"Banner ribbon text (rendered uppercase)",required:!1,type:{name:"string"}},{name:"count",description:"Numbered pastille badge (e.g. a threshold count)",required:!1,type:{name:"number"}},{name:"locked",description:"Greyed silhouette — not unlocked, or lapsed recurring supporter",required:!1,type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"size",description:"Rendered size in px (1:1)",required:!1,type:{name:"number"},defaultValue:{func:!1,value:"96"}},{name:"name",description:"Accessible name (English label of the badge)",required:!1,type:{name:"string"}},{name:"description",description:"Localized description, shown as a native tooltip",required:!1,type:{name:"string"}}],sourceFiles:["/home/runner/work/waypoint360-ui/waypoint360-ui/src/components/WpPatch/WpPatch.vue"]});const ee={title:"Community/WpPatch",component:k,tags:["autodocs"],argTypes:{shape:{control:"select",options:["circle","shield","rocker","rosette","hexagon"]},tier:{control:"select",options:["none","bronze","silver","gold","platinum"]},accent:{control:"color"},icon:{control:"select",options:[void 0,"propeller","check","globe","star","heart","flag"]},count:{control:"number"},size:{control:"number"},locked:{control:"boolean"}}},i={name:"Circle — flights",args:{shape:"circle",tier:"gold",icon:"propeller",bannerText:"Aviator",count:100,name:"Aviator",description:"100 vols enregistrés."}},l={name:"Shield — certification",args:{shape:"shield",tier:"silver",icon:"check",bannerText:"Certified",name:"Certified Pilot",description:"Au moins une certification UE."}},p={name:"Rocker — geography (country flag)",args:{shape:"rocker",tier:"bronze",flag:"fr",bannerText:"France",name:"France Explorer",description:"Au moins un vol en France."}},d={name:"Rocker — flag set (collectible)",render:e=>({components:{WpPatch:k},setup:()=>({args:e,countries:[{flag:"fr",label:"France"},{flag:"be",label:"Belgique"},{flag:"ch",label:"Suisse"},{flag:"es",label:"España"}]}),template:`
